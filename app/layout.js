...
export default function RootLayout({ children }) {
  ...
  const mensajePredeterminado = encodeURIComponent("¡Hola HOLO! ...");
    ...
    <html lang="es" className={`${fuenteTitulos.variable} ${fuenteTextoBase.variable}`}>
      ...
      >
        ...
        <a
          ...
          className="fixed bottom-3 right-6 z-50 bg-[#25D366] text-white p-3.5 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 hover:bg-[#20ba5a] flex items-center justify-center cursor-pointer group"
          title="Chatear con HOLO por WhatsApp"
        >
          <svg
