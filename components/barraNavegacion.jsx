...
export default function BarraNavegacion() {
    ...
    // Usamos una referencia para guardar el ID del temporizador y que no se borre entre renders
    const idTemporizador = useRef(null);

    // Traemos las categorías dinámicas desde Supabase
    useEffect(() => {
    ...
    // Limpiamos el temporizador si el componente se desmonta para evitar fugas de memoria
    useEffect(() => {
        return () => {
    ...
    // --- CONTROLADORES DEL TEMPORIZADOR DE MOUSE ---
    const manejarEntradaMouse = () => {
        // Si había un cierre programado en camino, lo cancelamos al toque
    ...
    const manejarSalidaMouse = () => {
        // Programamos el cierre para que pase exactamente dentro de 1 segundo (1000ms)
    ...
    return (
        <header className="sticky top-0 z-50 w-full bg-primary/95 backdrop-blur-md px-6 py-4 transition-all duration-200 shadow-sm border-b border-primary/20">
            <div className="max-w-6xl mx-auto flex items-center justify-between">

                {/* LOGO Y NOMBRE EN COLOR CREMA */}
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    {/* DROPDOWN PRODUCTOS CON RETARDO DE CIERRE */}
                    <div
                        className="relative"
                    ...
                    >
                        ...
                        {/* Caja del Dropdown */}
                        {desplegableAbierto && (
                            <div className="absolute left-0 w-52 bg-white border border-slate-100 shadow-xl rounded-xl py-2 mt-1 animate-in fade-in slide-in-from-top-1 duration-150">
                                <Link
                                    href="/productos"
            ...
            {menuCelularAbierto && (
                <div className="md:hidden border-t border-white/10 bg-primary px-6 py-6 flex flex-col gap-5 animate-in fade-in slide-in-from-top-2 duration-200">
                    <Link
                        href="/"
